...
import { useState } from "react";const Navbar = ({ currentUser, setCurrentUser }) => {
  const [showMenu, setShowMenu] = useState(false);  const logout = ()=>{
   ...
   return (
    <Nav justify="space-between" wrap="wrap">
      ...
      <Menu showMenu={showMenu}>
        ...
        <MenuLink to="/about">About</MenuLink>        {currentUser ? (
